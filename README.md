...
| Модель | CV Accuracy | CV AUC |
|---|---:|---:|
| et | 0.797 ± 0.020 | 0.858 ± 0.018 |
| torch | 0.778 ± 0.020 | 0.820 ± 0.024 |
| rf | 0.772 ± 0.033 | 0.838 ± 0.015 |
| logreg | 0.765 ± 0.015 | 0.808 ± 0.029 |
| mlp | 0.763 ± 0.010 | 0.828 ± 0.026 |
| hgb | 0.759 ± 0.028 | 0.788 ± 0.034 |
| xgb | 0.737 ± 0.038 | 0.806 ± 0.024 |
| catboost | 0.706 ± 0.040 | 0.832 ± 0.027 |
...
| cb_wcg | 0.855 ± 0.012 |
| et_wcg | 0.853 ± 0.019 |
| torch_wcg | 0.847 ± 0.010 |
| rf_wcg | 0.845 ± 0.019 |
| logreg_wcg | 0.837 ± 0.019 |
| xgb_wcg | 0.833 ± 0.014 |

| Дополнительно | Значение |
|---|---:|
| Train sanity accuracy (WCG) | 0.900 |
